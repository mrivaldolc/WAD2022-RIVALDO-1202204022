            ...
            <div class="d-flex justify-content-around">
                <div class="col-3 m-1">
                    <div class="card shadow-sm rounded" >
                        ...
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">6 KURSI</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">2000 CC</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">MATIC</p>
                        <hr class="m-0">
                ...
                <div class="col-3 m-1 ms-2 me-2">
                    <div class="card shadow-sm rounded" >
                        ...
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">7 KURSI</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">3000 CC</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">4WD MATIC</p>
                        <hr class="m-0">
                        <div class="text-center bg-light">
                ...
                <div class="col-3 m-1">
                    <div class="card shadow-sm rounded" >
                        ...
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">7 KURSI</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">1500 CC</p>
                        <hr class="m-0"><p class="m-2" style="text-align: center; color: blue;">MATIC</p>
                        <hr class="m-0">
                        <div class="text-center bg-light">
