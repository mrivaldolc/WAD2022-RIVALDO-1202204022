...
<section id="register">
    <div class="container-fluid">
        <div class="row align-items-center">
            <div class="col-md-6 min-vh-100 left">
                <img src="https://cdn0-production-images-kly.akamaized.net/dlE_TkbVSgvz7lRXKHN2poJNunA=/1200x1200/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3561528/original/060521700_1630783034-IMG_20210902_183634.jpg" style="object-fit:fill; width:100%; height:100%;" alt="foto">
            </div>
            <div class="col-md-6">
                    ...
                    <form action="{{ url('/register')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4">
                            ...
                            <input type="name" id="name" class="form-control form-control-lg" name="name"
                                placeholder="Silahkan masukan name" required />
                        </div>
                        <!-- no hp input -->
                        <div class="form-outline mb-4">
                            ...
                            <input type="no_hp" id="no_hp" class="form-control form-control-lg" name="no_hp"
                                placeholder="Silahkan masukan No Hp" required />
                        </div>
                        <!-- Password input -->
                        <div class="form-outline mb-4">
  ...
  <!-- footer -->
<footer class=" text-center pt-3 bg-light">
